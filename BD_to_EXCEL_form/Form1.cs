    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < selDt.Rows.Count+1; i++)
            {
                ...
                comm.CommandText = "DELETE * FROM SHABLON"; 
                comm.ExecuteNonQuery();
                conn.Close();
                log(System.IO.Path.GetDirectoryName(Application.ExecutablePath)+@"\SHABLON.dbf");

                FileInfo fn = new FileInfo(System.IO.Path.GetDirectoryName(Application.ExecutablePath) + @"\SHABLON.dbf");
                fn.CopyTo(System.IO.Path.GetDirectoryName(Application.ExecutablePath) + @"\Data\SHABLON.dbf", true);
